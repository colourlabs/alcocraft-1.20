...
public class KegCategory implements IRecipeCategory<KegRecipe> {
    ...
    public final static ResourceLocation TEXTURE = new ResourceLocation(AlcoCraft.MOD_ID, "textures/gui/jei_gui.png");
    ...
    // Remove getUid() and getRecipeClass() entirely, add this instead:
    public static final mezz.jei.api.recipe.RecipeType<KegRecipe> RECIPE_TYPE = mezz.jei.api.recipe.RecipeType
            .create(AlcoCraft.MOD_ID, "beer_brewing", KegRecipe.class);
    ...
    @Override
    public void setRecipe(@Nonnull IRecipeLayoutBuilder builder, @Nonnull KegRecipe recipe,
